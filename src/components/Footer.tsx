        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="WhatsApp"
              className="w-9 h-9 rounded-full bg-dark-3 border border-gold/15 flex items-center justify-center text-cream/50 hover:text-[#25D366] hover:border-[#25D366]/40 transition-all duration-300"
            >
            ...
            <a
              ...
              className="w-9 h-9 rounded-full bg-dark-3 border border-gold/15 flex items-center justify-center text-cream/50 hover:text-[#E1306C] hover:border-[#E1306C]/40 transition-all duration-300"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
