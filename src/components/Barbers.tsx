const barbers = [
  {
    ...
    description: 'Especialista en fades y cortes modernos. Con más de 5 años de experiencia, Agus es experto en degradés perfectos y diseños personalizados.',
  ...
  },
  {
    ...
    description: 'Apasionado por los cortes clásicos y el cuidado de barba. Gena combina técnica tradicional con toques contemporáneos en cada servicio.',
    schedule: 'Lun–Vie: 9 a 20 h · Sáb: 10 a 16 h',
    wa: 'Gena+Rainero',
  },
  {
    ...
    description: 'Maestro en texturas y estilos urbanos. Juan se destaca por su precisión en el trabajo con máquina y su ojo para el detalle.',
    schedule: 'Lun–Vie: 9 a 20 h · Sáb: 10 a 16 h',
  ...
  },
  {
    ...
    description: 'Referente en coloración capilar masculina. Leo transforma looks con técnicas de color avanzadas y degradés artísticos.',
    schedule: 'Lun–Vie: 9 a 20 h · Sáb: 10 a 16 h',
    wa: 'Leo+Merindol',
  },
  {
    ...
    description: 'Con una mirada atenta al estilo de cada cliente, Maxi crea cortes que resaltan la personalidad única de cada persona.',
    schedule: 'Lun–Vie: 9 a 20 h · Sáb: 10 a 16 h',
    wa: 'Maxi+Rubiolo',
  },
]
